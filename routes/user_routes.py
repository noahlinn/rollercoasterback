...
def apply_users_routes(app):
    ...
    app.route('/users/credits/<int:id>', methods=["PUT", "GET"])(users_controller.credits)
    app.route('/users/bucketlist/<int:id>', methods=["PUT", "GET"])(users_controller.add_to_bucketlist)